...
// Perbaikan: Mengembalikan std::string agar memori tidak terhapus sebelum digunakan
std::string utf16_to_utf8(const UTF16* source, size_t len) {
...
// ========================================================================================================================================== //
// Perbaikan: Menggunakan static cached string agar pointer c_str() tetap valid saat dibaca
const char* Il2CppString::CString() {
    static std::string cached_cstring;
    cached_cstring = utf16_to_utf8(&this->start_char, this->length);
    return cached_cstring.c_str();
}
// ========================================================================================================================================== //
...
// Perbaikan: Menambahkan return agar tidak warning non-void function
void *Il2Cpp::Invoke(void* method, void* obj, void** params, void* exec){
    return il2cpp_runtime_invoke(method, obj, params, exec);
}
